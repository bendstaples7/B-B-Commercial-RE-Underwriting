...
class PipelineStageConfigSchema(RequestSchema):
    """Schema for lead_status pipeline stage configuration (score bonuses)."""
    ...
    # Negative weights are intentional (early / parked stages score lower).
...
class OrganizationSchema(Schema):
    ...
    registered_office_address = fields.Str(dump_only=True, allow_none=True)
    entity_lookup_status = fields.Str(dump_only=True, allow_none=True)
    entity_lookup_provider = fields.Str(dump_only=True, allow_none=True)
    entity_lookup_checked_at = fields.DateTime(dump_only=True, allow_none=True)
    entity_lookup_error = fields.Str(dump_only=True, allow_none=True)
    entity_lookup_person_found = fields.Bool(dump_only=True)
    created_at = fields.DateTime(dump_only=True)
    updated_at = fields.DateTime(dump_only=True)
...
VALID_TIMELINE_EVENT_TYPES = [
    'note_added', 'email_logged', 'call_logged', 'meeting_logged', 'task_created', 'task_completed',
    'task_snoozed', 'recommended_action_changed', 'status_changed',
    'hubspot_note', 'hubspot_call', 'hubspot_meeting', 'hubspot_task', 'hubspot_deal_stage',
