...
_KNOWN_REVISIONS = frozenset({
    ...
    # former_owner role + lead_owner_snapshots for prior-owner history
    'stale_own_20260717',
    # unique recent_sale snapshot per lead+sale
    'stale_uq_20260717',
    ...
    'wh_skip_20260723',
    # Mail campaign submit reconciliation + address feedback rollup
    'mail_rec_20260727',
    # OLC tracked/omitted lead id lists on mail campaigns
    'mail_omit_20260727',
    ...
    'mail_nudge_20260814',
    # Same-person owner split: reactivate dialed contact, merge GIS dump phones
    'heal_own_20260819',
    # Unpark HubSpot Deprioritize when follow-up/mail work is still open
    'heal_depri_20260819',
    # Manual owner-name lock (GIS must not overwrite typed spelling)
    'name_lock_20260819',
    ...
    'c5d6e7f8a9b0',
    # Outcome-calibration metadata on scoring_weights
    'score_cal_20260907',
    ...
    'mail_stg_20260910',
    # Interim mail_queue status submitted (await OLC confirm before sent)
    'mail_sub_20260910',
