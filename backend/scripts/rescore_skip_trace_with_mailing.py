...
Promotes them to mailing_no_contact_made via LeadScoringEngine.compute
and refreshes recommended_action.
...
def main() -> int:
    ...
    with app.app_context():
        ...
        logger.info('Done apply=%s count=%d', apply, len(leads))
    return 0
