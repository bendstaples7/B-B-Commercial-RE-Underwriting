...
| LLC → person resolution (IL) | [`EntityResolutionService`](../backend/app/services/entity_resolution_service.py) + free [`IllinoisSosBulkProvider`](../backend/app/services/entity_lookup/ilsos_bulk.py) (Transparency Act bulk Managers/Name/Agent). Paid OpenCorporates adapter exists but is not default. | Scraping interactive ILSOS search; Cook County plugins owning SOS/manager lookup; calling skip-trace vendors from entity resolution |
